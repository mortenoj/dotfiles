...

  {
    ...
    config = function()
      ...
      local on_attach = function(client, bufnr)
        ...
        keymap("n", "<leader>ac", function() vim.lsp.buf.code_action({ context = { only = { "quickfix" } } }) end, opts)
...
-- keymap("n", "<leader>fr", require("telescope.builtin").lsp_references, { desc = "Find references" })
