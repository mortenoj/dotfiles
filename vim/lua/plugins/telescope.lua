return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fd", "<cmd>Telescope diagnostics<cr>") -- Adjusted for diagnostics
			vim.keymap.set("n", "<leader>fb", "<cmd>Telescope buffers<cr>")
			vim.keymap.set("n", "<leader>fc", "<cmd>Telescope git_bcommits<cr>")
			vim.keymap.set("n", "<leader>fh", "<cmd>Telescope help_tags<cr>")
			vim.keymap.set("n", "<leader>ee", "<cmd>Telescope colorscheme<cr>") -- Changed to <leader>c for colorscheme picker
